...
2. Now you are ready to build the docs as follows:
   ...
   ```
   INFO    -  Your documentation should shortly be available at: https://rays22.github.io/physiological-process-ontology/ 
   ```
3. Just to double check, you can now navigate to your documentation pages (usually https://rays22.github.io/physiological-process-ontology/). 
