# Contributing to Physiological Process Ontology (PPO)
...
The Physiological Process Ontology (PPO) team strives to create a
...
Please use our [Issue Tracker](https://github.com/rays22/physiological-process-ontology/issues/) for reporting problems with the ontology. 
...
Request a new term _via_ the GitHub [Issue Tracker](https://github.com/rays22/physiological-process-ontology/issues/).

It is important to remember that it takes a lot of time for curators to process issues submitted to the tracker.
To make this work easier, please always use issue templates if they are available (https://github.com/rays22/physiological-process-ontology/issues/new/choose).
...
1. Open src/ontology/PPO-edit.obo in your favourite editor, i.e. [Protege](https://protege.stanford.edu/). **Careful:** double check you are editing the correct file. There are many ontology files in this repository, but only one _editors file_!
